...
<Button type='button' icon='/play.svg' title='How it work?' full variant='btn_white_text' />
</div>
</div>
...
<p className='bold-20 text-white'>Aguas Calientis</p>
</div>
...
<p className='bold-20 text-white'>173.29ml</p>
</div>
<div className='flex flex-col'>
<p className='regular-16 block text-gray-20'>Elevation</p>
<p className='bold-20 text-white'>3.21km</p>
</div>
</div>
</div>
</div>
